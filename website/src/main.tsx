...
function App() {
  return <main>
    <nav><a className="logo" href="#top"><span>◆</span> TotaAI</a><div className="links"><a href="#mozliwosci">Możliwości</a><a href="#start">Szybki start</a><a className="github" href="https://github.com/totatomasz13-web/TotaAI">GitHub ↗</a></div></nav>
    <section className="hero" id="top"><div className="eyebrow">POLSKI FRAMEWORK AI · v0.1.0</div><h1>Buduj AI.<br /><em>Po swojemu.</em></h1><p className="lead">Czytelna biblioteka uczenia maszynowego z polskim API. Od pierwszego neuronu do własnego modelu, bez bariery terminologii.</p><div className="actions"><a className="primary" href="#start">Zacznij budować <span>→</span></a><a className="secondary" href="https://pypi.org/project/totaai/">pip install totaai</a></div></section>
